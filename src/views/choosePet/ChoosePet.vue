      ...
      <div class="petCard" v-for="item in list">
        ...
        <div class="content">
          <div class="content1">
            ...
            <div class="right">
              <span class="edit" v-if="item.orderlies_id" @click="choosePet(item.pet_id)">选择</span>
              <span class="edit" v-if="!item.orderlies_id" @click="choosePet2(item.pet_id)">选择</span>
            </div>
          </div>
          <div class="content2">
    ...
    checkOrderlies(id) {
      getData("api", {
        ...
        if (data) {
          ...
          this.$router.push({ name: "confirmOrder", query: { id: id } });
        }
