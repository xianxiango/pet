    ...
    <div class="public-view">
      <div class="info">
        ...
        <div class="content1 typeInfo">
          ...
          <div class="right">
            <XRadioGroup v-model="petType" class="radioGroup">
      ...
      <div class="next" @click="addPet()">下一步</div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    addPet() {
      fetchData("/hapi/pet/add", {
        cat_dog: this.petType,
        ...
        if (data) {
          this.checkOrderlies(data.pet_id);
        }
      });
    },
    checkOrderlies(id) {
